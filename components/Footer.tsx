        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-heading font-semibold">Cosmo Granites</span>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm text-gray-300">
                  <p>123 Stone Gallery Road</p>
                  <p>Chennai, Tamil Nadu 600001</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                <a href="tel:+919876543210" className="text-sm text-gray-300 hover:text-primary transition-colors">
                  +91 98765 43210
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-primary flex-shrink-0" />
                <a href="mailto:info@cosmofloor.com" className="text-sm text-gray-300 hover:text-primary transition-colors">
                  info@cosmofloor.com
                </a>
              </div>
            </div>
